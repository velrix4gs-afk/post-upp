    ...
    >
      <div className={`h-10 w-10 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${
        ...
        <Icon className={`h-5 w-5 transition-all duration-300 ${
          variant === 'destructive' 
            ? 'text-destructive group-hover:scale-110' 
            : 'text-foreground group-hover:text-primary group-hover:scale-110'
        }`} />
      </div>
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <SheetContent side="right" className="w-[400px] p-6 overflow-y-auto bg-background/95 backdrop-blur-xl border-l">
        {/* Profile Section */}
        <div 
          className="group flex items-center gap-3 p-4 rounded-2xl hover:bg-gradient-to-r hover:from-primary/10 hover:to-primary/5 cursor-pointer transition-all duration-300 mb-6 border border-transparent hover:border-primary/20 hover:shadow-lg hover:scale-[1.02]"
        ...
        <div className="space-y-1.5 mb-6">
          <div
            ...
            className="group flex items-center gap-3 p-3 rounded-xl cursor-pointer hover:bg-gradient-to-r hover:from-warning/10 hover:to-warning/5 transition-all duration-300 hover:shadow-md hover:scale-[1.02] border border-transparent hover:border-warning/20"
          >
        ...
        <div className="space-y-1.5 mb-6">
          <div
            ...
            className="group flex items-center gap-3 p-3 rounded-xl cursor-pointer hover:bg-muted hover:shadow-md transition-all duration-300 hover:scale-[1.02]"
          >
